...
This project now uses a complete React + Vite + TypeScript frontend with Tailwind and shadcn-style component structure, plus a FastAPI backend for inference. used to detect ragging
